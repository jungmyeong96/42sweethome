...
/*   Updated: 2021/03/03 19:43:53 by daekim           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void		cal_fb(t_info *p)
{
	if (p->key_w == 1)
	{
		if (p->data.map[(int)(p->pos_x + p->dir_x * p->move)][(int)(p->pos_y)] != '1')
			p->pos_x += p->dir_x * p->move;
		if (p->data.map[(int)(p->pos_x)][(int)(p->pos_y + p->dir_y * p->move)] != '1')
...
static void		cal_rl(t_info *p)
{
	if (p->key_d == 1)
	{
	if (p->data.map[(int)(p->pos_x + p->plane_x * p->move)][(int)(p->pos_y)] != '1')
		p->pos_x += p->plane_x * p->move;
	if (p->data.map[(int)(p->pos_x)][(int)(p->pos_y + p->plane_y * p->move)] != '1')
