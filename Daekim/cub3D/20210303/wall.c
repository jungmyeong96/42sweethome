...
/*   Updated: 2021/03/03 06:52:20 by daekim           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		tex_wall(t_info *p)
{
	...
	tex_in(p, p->texture[3], "tex/grey.xpm", &i);
	...
	tex_in(p, p->texture[8], "tex/barrel.xpm", &i);
	tex_in(p, p->texture[9], "tex/pillar.xpm", &i);
	tex_in(p, p->texture[10], "tex/greenlight.xpm", &i);
}
