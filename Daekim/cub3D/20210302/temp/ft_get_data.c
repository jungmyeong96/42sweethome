...
/*   Updated: 2021/03/02 05:09:40 by daekim           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
//	if (ft_strncmp(data[0], "R", 1))
//		screen_size(p, data[1], data[2]);
	if (ft_strncmp(data[0], "NO", 2))
		tex_data(p, data[1], 0);
	else if (ft_strncmp(data[0], "SO", 2))
		tex_data(p, data[1], 1);
	else if (ft_strncmp(data[0], "WE", 2))
		tex_data(p, data[1], 2);
	else if (ft_strncmp(data[0], "EA", 2))
		tex_data(p, data[1], 3);
	else if (ft_strncmp(data[0], "S", 1))
		tex_data(p, data[1], 4);
	else if (ft_strncmp(data[0], "F", 1))
		tex_data(p, data[1], 5);
