...
/*   Updated: 2021/03/04 20:00:10 by daekim           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
	if (p->data.map[c->mapY][c->mapX] == 1)
		c->color = 0xFF0000;
	else if (p->data.map[c->mapY][c->mapX] == 2)
		c->color = 0x00FF00;
	else if (p->data.map[c->mapY][c->mapX] == 3)
		c->color = 0x0000FF;
	else if (p->data.map[c->mapY][c->mapX] == 4)
		c->color = 0xFFFFFF;
	else
		c->color = 0xFFFF00;
	if (c->side == 1)
...
//		verline(p, x, p->cal.draw_st, p->cal.draw_en);
		x++;
	}
}
