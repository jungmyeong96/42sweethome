...
/*   Updated: 2021/03/12 05:27:01 by daekim           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (y > p->data.win_h / 2 + p->pitch)
	{
		c->per = y - p->data.win_h / 2 - p->pitch;
		c->cam_z = 0.5 * p->data.win_h + p->pos_z;
	}
	else
	{
		c->per = p->data.win_h / 2 - y + p->pitch;
		c->cam_z = 0.5 * p->data.win_h - p->pos_z;
	}
