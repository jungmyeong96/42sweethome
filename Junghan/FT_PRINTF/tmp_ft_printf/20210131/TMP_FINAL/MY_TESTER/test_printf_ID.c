...
/*   Updated: 2021/01/28 22:55:40 by junghan          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	printf("test5[.-20]:%.-20d!\n",123123); //negative precision

	printf("\n\n------------2 option------------\n\n");

	printf("test6[   10.20]:%   10.20d!\n",123);

	printf("test7[20.10]:%20.10d!\n",123);
	...
	printf("test24[10.0/0]:%10.0d!\n",0);

	printf("test25[0.10/0]:%0.10d!\n",0);

	printf("test26[0.10/123]:%0.10d!\n",123);
